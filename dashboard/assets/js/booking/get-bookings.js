  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      $.each(data, function (index, result) {
        ...
        var formattedDate = new Date(result.date_start);
        ...
        var newRow = '<tr>' +
          ...
          '<td class="align-middle text-center">' + result.space_id + '</td>' +
          '<td class="align-middle text-center">' + result.duration_days + '</td>' +
          '<td class="align-middle text-center">' + dateStart + '</td>' +
          '<td class="align-middle text-center">' + dateEnd + '</td>' +
          '<td class="align-middle">' +
          '<div class="d-flex justify-content-center align-items-center gap-1">' +
          '<button type="button" class="btn btn-sm btn-primary"><i class="bx bx-link-external" ></i></button>' +
          '<button type="button" class="btn btn-sm btn-secondary"><i class="bx bx-qr" ></i></button>' +
          '</div>' +
          '</td>' +
          '</tr>';
