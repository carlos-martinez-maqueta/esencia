...
<div class="container-fluid px-4">
                    ...
                    <div class="card-body row">
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="d-grid align-items-center">
                                <a href="#" class="btn btn-warning mb-2 edit-timeline" data-id="<?= $result->id ?>" data-bs-toggle="modal" data-bs-target="#editModal"><i class='bx bx-edit-alt'></i></a>
                                <a href="#" class="btn btn-danger danger-timeline" data-id="<?= $result->id ?>"><i class='bx bx-trash'></i></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <form id="edit-form-timeline" method="POST" enctype="multipart/form-data">
                <div id="editTimeLineModal" class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="editModalLabel">Edit Timeline</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="col-12">
                            <div class="col-12 mb-2">
                                <label for="year" class="form-label font_three">Year</label>
                            ...
                            <div class="col-12 mb-3">
                                <textarea class="form-control" name="description" id="summer2" cols="30" rows="5"></textarea>
                            </div>
                        </div>
