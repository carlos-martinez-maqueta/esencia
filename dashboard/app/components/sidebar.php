...
<div id="sidebar-wrapper">
    ...
    <div class="list-group list-group-flush">
        <a href="index" class="list-group-item list-group-item-action bg-transparent text-color-sidebar active small"><i class="fas fa-tachometer-alt me-2"></i>Dashboard</a>
        <button class="list-group-item list-group-item-action bg-transparent text-color-sidebar  font_one small" data-bs-toggle="collapse" data-bs-target="#collapseIngresos" aria-expanded="true" aria-controls="collapseIngresos">
