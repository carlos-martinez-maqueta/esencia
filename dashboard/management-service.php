...
$folderServiceObj = Folder::getFolderService();
...
<div class="container-fluid px-4">
    <form id="edit-service" method="POST" enctype="multipart/form-data">
        <!-- Page Heading -->
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800 d-flex align-items-center gap-2 font_two">Management Service</h1>
            ...
            <div class="col-xl-12 col-md-12 mb-4">
                ...
                <div class="col-12 mb-3 row">
                    <div class="col-xl-6 col-md-12 p-4">
                        <div>
                            <img src="files/service/<?= $folderServiceObj->banner ?>" class="img-fluid" alt="">
                        </div>
                    </div>
                    <div class="col-xl-6 col-md-12 p-4">
                        <div class="card">
                            <div class="card-header text-center">
                                <h4>Edit service banner</h4>
                            </div>
                            <div class="card-body"> 
                ...
                <div class="col-12 mb-2">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" name="title" value="<?= $folderServiceObj->title ?>">
                </div>
                <div class="col-12 mb-2 d-flex justify-content-between">
                    <label for="exampleInputEmail1" class="form-label font_three">Description</label>
                </div>
                <div class="col-12 mb-3">
                    <textarea class="form-control" name="description" id="summer" cols="30" rows="5"><?= $folderServiceObj->description ?></textarea>
                </div>
            </div>
        </div>
    </form>
...
<script src="assets/js/folder/service/edit.js"></script>