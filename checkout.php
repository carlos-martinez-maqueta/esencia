...
try {
  // Datos del producto
  $productData = [
    'name' => 'ESENCIA, VILLA TULUM',
    'description' => 'Reserva Villa Tulum, Mexico',
  ...
  $checkout_session = $stripe->checkout->sessions->create([
    ...
    'line_items' => [[
      'price_data' => [
        ...
        'unit_amount' => 2000, // El precio en centavos (2000 centavos = 20 USD)
      ],
      'quantity' => 1,
    ]],
    'mode' => 'payment',
    ...
    'return_url' => 'http://localhost:8012/esencia/pago-realizado?session_id={CHECKOUT_SESSION_ID}',
  ]);
